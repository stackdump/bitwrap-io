...
func TestAllCircuitsCompile(t *testing.T) {
	...
	expected := []string{"transfer", "transferSynth", "transferFrom", "transferFromSynth", "mint", "mintSynth", "burn", "burnSynth", "approve", "approveSynth", "vestClaim", "vestClaimSynth", "voteCast"}
